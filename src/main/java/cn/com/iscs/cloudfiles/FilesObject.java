...
public class FilesObject
{
    ...
    {
        if (name.length() > com.mosso.client.cloudfiles.FilesConstants.OBJECT_NAME_LENGTH)
        {
            logger.warn("Object name larger than " + com.mosso.client.cloudfiles.FilesConstants.OBJECT_NAME_LENGTH + " characters truncating from: "+name);
