...
public class FilesObjectMetaData
{
   ...
   void setLastModified(String lastModified)
    ...
    {
        metaData.put(com.mosso.client.cloudfiles.FilesConstants.X_OBJECT_META.concat(key), value);
    }
    ...
    {
        return metaData.get(com.mosso.client.cloudfiles.FilesConstants.X_OBJECT_META.concat(key));
    }
